...
simulate()
{
  xsim fmd -key {Behavioral:sim_1:Functional:fmd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_51bb.protoinst" -protoinst "protoinst_files/fmd.protoinst" -log simulate.log
}
