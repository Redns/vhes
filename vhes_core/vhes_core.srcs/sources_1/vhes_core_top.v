...
module vhes_core_top(
    /* ϵͳ�ź� */
    input rst_n_i,                                  // ��λ�ź����루�͵�ƽ��Ч??
    input clk_100M_i,                               // 100MHz ʱ���ź�����
    output rst_done_o,                              // ��λ��ɱ�־
    /* FEP ��Ƶ�ɼ�?? ADV7611 �����ź� */ 
    inout sil_sda,                                  // SIL9011 IIC �����ź�
    output sil_scl,                                 // SIL9011 IIC ʱ���ź�
    /* HDMI �г�ͬ���ź� */ 
    input pclk_i,                                   // ����ʱ������??1080P@60fps??148.5MHz??
    input hsync_i,                                  // ��ͬ���ź���??
    input vsync_i,                                  // ��ͬ���ź���??
    input [23:0] rgb_i,                             // RGB888 �ź�����
    input de_i,                                     // ������Ч��־����
    /* HEVC ������� */ 
    input bs_rd_clk_i,                              // ������ȡʱ�ӣ�����Ϊ 50MHz??
    output bs_valid_o,                              // ������Ч��־���
    output [31:0] bs_data_o,                        // �������ݣ�LCU ����??
    /* DDR ����ź� */ 
