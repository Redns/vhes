...
HD_PWD='E:/Project/xk265/hevc_encoder_system/hevc_encoder_system.runs/hevc_encoder_system_hdmi_adv7611_init_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hevc_encoder_system_hdmi_adv7611_init_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hevc_encoder_system_hdmi_adv7611_init_0_2.tcl
