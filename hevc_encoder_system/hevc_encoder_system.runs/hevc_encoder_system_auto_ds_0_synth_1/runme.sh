...
HD_PWD='E:/Project/xk265/hevc_encoder_system/hevc_encoder_system.runs/hevc_encoder_system_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hevc_encoder_system_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hevc_encoder_system_auto_ds_0.tcl
