...
HD_PWD='E:/Project/xk265/hevc_encoder_system/hevc_encoder_system.runs/fdma_mig_ddr_uiFDMA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fdma_mig_ddr_uiFDMA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fdma_mig_ddr_uiFDMA_0_0.tcl
