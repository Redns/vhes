...
set genomeRtd $env(RT_TMP)/253DC3A5C30.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__88_fetch_ref_luma}]"
...
set genomeName [subst -nocommands -novariables {muxpart__88_fetch_ref_luma}]
