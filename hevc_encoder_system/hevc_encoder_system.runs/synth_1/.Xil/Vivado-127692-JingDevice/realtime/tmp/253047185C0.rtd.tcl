...
set genomeRtd $env(RT_TMP)/253047185C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mem_lipo_1p_128x64x4}]"
...
set genomeName [subst -nocommands -novariables {mem_lipo_1p_128x64x4}]
