...
set genomeRtd $env(RT_TMP)/2538CC0D830.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {datapath__50_fetch_ref_luma__GD}]"
...
set genomeName [subst -nocommands -novariables {datapath__50_fetch_ref_luma__GD}]
