...
set genomeRtd $env(RT_TMP)/25327065170.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mem_bilo_db}]"
...
set genomeName [subst -nocommands -novariables {mem_bilo_db}]
