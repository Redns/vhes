...
set genomeRtd $env(RT_TMP)/253942A0700.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {fetch_ref_luma__GB2}]"
...
set genomeName [subst -nocommands -novariables {fetch_ref_luma__GB2}]
