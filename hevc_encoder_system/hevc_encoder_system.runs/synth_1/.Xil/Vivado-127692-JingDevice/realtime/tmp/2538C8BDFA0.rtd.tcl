...
set genomeRtd $env(RT_TMP)/2538C8BDFA0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {rec_buf_wrapper__GCB0}]"
...
set genomeName [subst -nocommands -novariables {rec_buf_wrapper__GCB0}]
