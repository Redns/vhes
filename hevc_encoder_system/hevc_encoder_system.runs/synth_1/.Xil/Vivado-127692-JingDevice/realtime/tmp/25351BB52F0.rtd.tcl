...
set genomeRtd $env(RT_TMP)/25351BB52F0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__1876_sram_sp_be_behave__parameterized1__GD}]"
...
set genomeName [subst -nocommands -novariables {case__1876_sram_sp_be_behave__parameterized1__GD}]
