...
HD_PWD='E:/Project/xk265/hevc_encoder_system/hevc_encoder_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2yuv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2yuv.tcl
