...
#
# Generated by export_simulation on Tue May 09 23:30:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './vhes.sh' script.
...
./vhes.sh -noclean_files

For more information on the script, please type './vhes.sh -help'.
