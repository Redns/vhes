...
/****************************** 宏定义 ***************************/
    ...
    `define FILE_VIDEO_ORIGIN   "E:/Project/xk265/f265_sw/blue_sky.yuv"   
    `define FILE_CHECK_BS       "E:/Project/xk265/f265_sw/s_bit_stream.dat"
...
/***************************** 主体逻辑 **************************/
    ...
    initial begin
        ...
        /******************* 复位模块 ******************/
            ...
            wait(hevc_encode_system_top.enc_core_top.rstn);
        
        /******************* 监控变量 ******************/
            $monitor( "\tat %08d, Frame Number = %02d, mb_x_first = %02d, mb_y_first = %02d", $time, frame_serial_number, hevc_encode_system_top.enc_core_top.u_enc_ctrl.pre_l_x_o, hevc_encode_system_top.enc_core_top.u_enc_ctrl.pre_l_y_o);
