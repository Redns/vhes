...
module vsp_top_tb;
    ...
    vsp_top vsp_top(
        ...
        .bs_data_i(bs_data),
        .bs_valid_i(bs_valid),
        .hevc_bs_rd_en_i(hevc_bs_rd_en),
        .hevc_bs_valid_o(hevc_bs_valid),
        .hevc_bs_data_o(hevc_bs_data),
        .hevc_bs_overflow_o(hevc_bs_overflow)
    );
    ...
    initial begin
        ...
        @(posedge bs_rd_clk) hevc_bs_rd_en = 1'b1;
        #(1000 * `FULL_BS_RD_CLK) $stop;
    end
endmodule