...
vlog -work xpm  -incr -mfcu -sv "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
...
vlog -work xil_defaultlib  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
...
vlog -work axi_infrastructure_v1_1_0  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
"../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_26  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
"../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_7  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_25  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
"../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/5390/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_protocol_converter_v2_1_26  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
"../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/90c8/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \

vlog -work axi_clock_converter_v2_1_25  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
"../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/e893/hdl/axi_clock_converter_v2_1_vl_rfs.v" \

vlog -work blk_mem_gen_v8_4_5  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
"../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/25a8/simulation/blk_mem_gen_v8_4.v" \

vlog -work axi_dwidth_converter_v2_1_26  -incr -mfcu "+incdir+../../../../extif.gen/sources_1/bd/fdma_mig_ddr/ipshared/ec67/hdl" \
