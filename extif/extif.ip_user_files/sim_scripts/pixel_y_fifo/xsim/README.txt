...
#
# Generated by export_simulation on Fri Apr 21 10:18:56 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './pixel_y_fifo.sh' script.

./pixel_y_fifo.sh -reset_run
...
./pixel_y_fifo.sh -noclean_files

For more information on the script, please type './pixel_y_fifo.sh -help'.
