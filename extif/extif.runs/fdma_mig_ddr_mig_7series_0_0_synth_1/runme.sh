...
HD_PWD='E:/Project/xk265/extif/extif.runs/fdma_mig_ddr_mig_7series_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fdma_mig_ddr_mig_7series_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fdma_mig_ddr_mig_7series_0_0.tcl
