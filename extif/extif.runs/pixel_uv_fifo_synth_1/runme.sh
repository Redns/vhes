...
HD_PWD='E:/Project/xk265/extif/extif.runs/pixel_uv_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_uv_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_uv_fifo.tcl
