...
HD_PWD='E:/Project/xk265/extif/extif.runs/test_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_fifo.tcl
