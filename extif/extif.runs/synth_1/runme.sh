...
HD_PWD='E:/Project/xk265/extif/extif.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_buffer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_buffer_top.tcl
