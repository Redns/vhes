...
namespace eval ::optrace {
  variable script "E:/Project/xk265/extif/extif.runs/synth_1/video_buffer_top.tcl"
...
synth_design -top video_buffer_top -part xc7z035ffg676-2
...
write_checkpoint -force -noxdef video_buffer_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file video_buffer_top_utilization_synth.rpt -pb video_buffer_top_utilization_synth.pb"
