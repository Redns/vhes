...
namespace eval ::optrace {
  variable script "E:/Project/xk265/extif/extif.runs/pixel_y_fifo_synth_1/pixel_y_fifo.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir E:/Project/xk265/extif/extif.runs/pixel_y_fifo_synth_1 -new_name pixel_y_fifo -ip [get_ips pixel_y_fifo]]
...
synth_design -top pixel_y_fifo -part xc7z035ffg676-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix pixel_y_fifo_ pixel_y_fifo.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ pixel_y_fifo_stub.v
 lappend ipCachedFiles pixel_y_fifo_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ pixel_y_fifo_stub.vhdl
 lappend ipCachedFiles pixel_y_fifo_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ pixel_y_fifo_sim_netlist.v
 lappend ipCachedFiles pixel_y_fifo_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ pixel_y_fifo_sim_netlist.vhdl
 lappend ipCachedFiles pixel_y_fifo_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp pixel_y_fifo.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips pixel_y_fifo]
 }
...
rename_ref -prefix_all pixel_y_fifo_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef pixel_y_fifo.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "pixel_y_fifo_synth_1_synth_report_utilization_0" "report_utilization -file pixel_y_fifo_utilization_synth.rpt -pb pixel_y_fifo_utilization_synth.pb"
...
OPTRACE "pixel_y_fifo_synth_1" END { }
