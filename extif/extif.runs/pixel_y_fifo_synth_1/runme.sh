...
HD_PWD='E:/Project/xk265/extif/extif.runs/pixel_y_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_y_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_y_fifo.tcl
